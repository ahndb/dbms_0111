...
insert into `teams`
values(1, "DUSAN", "Seoul", 1999);
insert into `teams`
values(2, "LOTTE", "Busan", 1982);
insert into `teams`
values(3, "SK", "Incheon", 2000);
...
insert into `players`
values(101, "Kim Min", "타자", "1992-05-20");
insert into `players`
values(102, "Lee Joon", "투수", "1990-08-15");
insert into `players`
values(103, "Choi Hyeon", "내야수", "1988-03-05");
insert into `players`
values(104, "Park Seo", "외야수", "1994-11-22");
insert into `players`
values(105, "Jung Tae", "타자", "1993-07-30");
# 데이터 업데이트 (UPDATE)
